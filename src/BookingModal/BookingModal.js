...
const BookingModal = ({modalProduct,modalsetProduct}) => {
    const {productName,resellPrice,image}=modalProduct
        ...
        <div>
            ...
            <div className="modal">
                <div className="modal-box relative">
                       ...
                       <form onSubmit={bookingSubmit} className='grid grid-cols-1 gap-3 mt-10'>
